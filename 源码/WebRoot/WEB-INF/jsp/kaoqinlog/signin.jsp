...
<div class="pageContent">
	...
	<form method="post" name=form1 action="kaoqinlog/kaoqinlogadd4stu2.html" class="pageForm" onsubmit="return validateCallback(this,dialogAjaxDone);">
		...
		<div class="formBar">
			<ul>
				<li><div class="buttonActive"><div class="buttonContent"><button type="submit">签到</button></div></div></li>
